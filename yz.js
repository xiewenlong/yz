...
var Yz = (function() {
	...
	var isSensitiveWord = function(word) {
		var badword = [
			...
			"屁股", "小日本", "人模狗样", "钢珠枪", "嫖俄罗", "淫兽", "三八", "MMD", "坯子", "港澳博球",
	...
	/**
	 * 判断是否为姓名，中文为1~5个字符，或者英文开头的16个字符以内的字母数字组合
	 * @param  {[string]} str [用户输入的姓名]
	 * @return {[boolean]}     [符合姓名格式返回true,否则为false]
	 */
	var isTrueName = function(str){
		var pattern = /(^[\u4E00-\u9FA5]{1,5}$)|(^[a-zA-Z]{1}[a-zA-Z0-9]{1,15})$/;
		return pattern.test(str);
	}
